...
class PyTorchPositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model, dropout=0.1, max_len=5000):
        ...
        self.dropout = nn.Dropout(p=dropout)  # noqa
...
class DPTNetBlock(nn.Module):
    ...
    def __init__(
        ...
        self.dropout = Dropout(dropout)  # noqa
        ...
        self.activation = _get_activation_fn(activation)  # noqa
    ...
    def forward(self, src):
        ...
        src2 = self.rnn(src)[0]
        src2 = self.activation(src2)  # noqa
